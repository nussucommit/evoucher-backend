...
from organization.views import OrganizationDetail, OrganizationList, getOrgWoUname, getOrgnamebyUname, verifyOrganization
...
urlpatterns = [
    ...
    path('verifyorganization', verifyOrganization),
]